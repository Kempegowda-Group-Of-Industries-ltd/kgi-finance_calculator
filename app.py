...
from calculators.mortgage_calculator import mortgage_calculator  # New
from calculators.auto_loan_calculator import auto_loan_calculator  # New
from calculators.compound_interest_calculator import compound_interest_calculator  # New
...
if option == "Loan Calculator":
    ...
    mortgage_calculator()  # New
elif option == "Auto Loan Calculator":
    auto_loan_calculator()  # New
elif option == "Compound Interest Calculator":
    compound_interest_calculator()  # New
